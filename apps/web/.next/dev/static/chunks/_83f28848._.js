...
"[project]/apps/web/src/app/archive/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ArchivePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArchivePage.useEffect": ()=>{
            ...
            if (!hasToken) {
                const archived = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$mockTasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_TASKS"].filter({
                    "ArchivePage.useEffect.archived": (t)=>t.isArchived
                }["ArchivePage.useEffect.archived"]);
                setTasks(archived);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArchivePage.useEffect": ()=>{
            ...
            async function fetchFirstPage() {
                setLoading(true);
                setError(null);
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tasksApi"].getAll({
                    pageSize: PAGE_SIZE,
                    pageNumber: 1,
                    isArchived: true
                });
    ...
    const loadMore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ArchivePage.useCallback[loadMore]": async ()=>{
            ...
            setTasks({
                "ArchivePage.useCallback[loadMore]": (prev)=>[
                        ...prev,
                        ...data.data
                    ]
            }["ArchivePage.useCallback[loadMore]"]);
            setPageNumber(next);
        }
    }["ArchivePage.useCallback[loadMore]"], [
        loadingMore,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArchivePage.useEffect": ()=>{
            ...
            const obs = new IntersectionObserver({
                "ArchivePage.useEffect": (entries)=>{
                    if (entries.some({
                        "ArchivePage.useEffect": (e)=>e.isIntersecting
                    }["ArchivePage.useEffect"])) loadMore();
                }
            }["ArchivePage.useEffect"], {
                rootMargin: "200px"
            });
            obs.observe(node);
            return ({
                "ArchivePage.useEffect": ()=>obs.disconnect()
            })["ArchivePage.useEffect"];
        }
    }["ArchivePage.useEffect"], [
        hasMore,
    ...
    async function handleUnarchive(task) {
        ...
        if (!isAuthenticated) return;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tasksApi"].unarchive(task.taskId);
        if (error) {
            setTasks((prev)=>[
                    snapshot,
                    ...prev
    ...
    async function handleDelete(id) {
        ...
        setTotalCount((c)=>Math.max(0, c - 1));
        if (!isAuthenticated) return;
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2f$tasks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tasksApi"].delete(id);
        if (error) {
...
_s(ArchivePage, "GGyu83hfFL9Gt4+C4gwxQUTtCyg=", false, function() {
    return [
...
//# sourceMappingURL=_83f28848._.js.map